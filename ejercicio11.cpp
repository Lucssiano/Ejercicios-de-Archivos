/* 11) Una aplicación para descargas de Series por la red posee la información en un archivo binario, Episodios.dat, con un
registro por cada episodio, ordenado ascendente por IdSerie y Número de temporada, con el siguiente diseño:
